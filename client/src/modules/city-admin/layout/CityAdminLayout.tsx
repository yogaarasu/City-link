    ...
    <div className="flex h-full flex-col overflow-y-auto overflow-x-hidden">
      ...
      <div className="mt-auto px-3 pb-4">
        ...
        <div className="flex flex-col gap-2">
          <Button
            variant="ghost"
            className="w-full justify-start gap-3 py-3 text-lg hover:bg-muted hover:text-foreground"
            onClick={() => {
              toggleLanguage();
            ...
            <DropdownMenuTrigger asChild>
              <Button variant="outline" className="h-auto w-full justify-start gap-3 py-3">
                ...
                <div className="flex min-w-0 flex-col items-start text-left">
                  <span className="truncate text-sm font-semibold">{user?.name ?? t("cityAdminRole")}</span>
          ...
          >
            <div className="relative">
              ...
              <div className="flex flex-col items-center gap-2 pt-1 pb-0.5">
                ...
                <p className="max-w-full truncate text-sm font-semibold">{user?.name ?? t("cityAdminRole")}</p>
