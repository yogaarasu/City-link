...
const CityAdminForm = ({
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    if (phoneDigits.length !== 10) {
      ...
      nextErrors.phone =
        "Phone must start with 6/7/8/9 and cannot be repeated or sequential digits.";
    }
  ...
  return (
    <form className="space-y-4" onSubmit={handleSubmit}>
      <div className="space-y-2">
        <Label htmlFor="city-admin-name">Name</Label>
        <Input
          id="city-admin-name"
          value={form.name}
      ...
      <div className="space-y-2">
        <Label htmlFor="city-admin-email">Email</Label>
        <Input
          id="city-admin-email"
          type="email"
          value={form.email}
      ...
      <div className="space-y-2">
        <Label htmlFor="city-admin-phone">Phone</Label>
      ...
      <div className="space-y-2">
        <Label htmlFor="city-admin-password">Initial Password</Label>
        <Input
      ...
      <p className="text-xs text-muted-foreground">
        System will auto-generate Admin ID based on district and year.
      </p>
